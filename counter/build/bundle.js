...
var AppComp = function (_React$Component) {
    _inherits(AppComp, _React$Component);
...
var AppContainer = (0, _reactRedux.connect)(null, null)(AppComp);
...
exports.default = function () {
    ...
    switch (action.type) {
        case _type.INCREMENT:
            return state + 1;
        case _type.DECREMENT:
            return state - 1;
        default:
            return state;
    }
...
var CounterComp = function (_React$Component) {
    _inherits(CounterComp, _React$Component);

    function CounterComp() {
        _classCallCheck(this, CounterComp);

        return _possibleConstructorReturn(this, (CounterComp.__proto__ || Object.getPrototypeOf(CounterComp)).apply(this, arguments));
    }

    _createClass(CounterComp, [{
        key: 'render',
        value: function render() {
            return _react2.default.createElement(
                'div',
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
    return {
        onIncrement: function onIncrement() {
            return dispatch((0, _counter.counterIncrement)());
        },
        onDecrement: function onDecrement() {
            return dispatch((0, _counter.counterDecrement)());
        }
    };
};

var CounterContainer = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(CounterComp);
...
exports.counterDecrement = exports.counterIncrement = undefined;

var _type = __webpack_require__(71);

var counterIncrement = exports.counterIncrement = function counterIncrement() {
  return { type: _type.INCREMENT };
};
var counterDecrement = exports.counterDecrement = function counterDecrement() {
  return { type: _type.DECREMENT };
};
